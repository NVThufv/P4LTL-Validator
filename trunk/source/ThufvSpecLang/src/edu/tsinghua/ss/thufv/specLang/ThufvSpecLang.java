...
import edu.tsinghua.ss.thufv.specLang.preferences.PreferenceInitializer;
 ...
 */
public class ThufvSpecLang implements IGenerator, ISource {
	...
	private ThufvSpecLangObserver mObserver;
	private IUltimateServiceProvider mServices;
	private IToolchainStorage mStorage;
	private final String[] mFileTypes;
	private ILogger mLogger;

	public ThufvSpecLang() {
	...
	public List<IObserver> getObservers() {
		mObserver = new ThufvSpecLangObserver(mServices);
